            ...
            communesLayer = L.geoJSON(filteredCommunes, {
              onEachFeature: function onEachFeature(feature, layer) {
                layer.on('click', function () {
                  ...
                  var ventesDansCetteCommune = ventes.filter(function (vente) {
                    return JSON.parse(vente.l_codinsee.replace(/'/g, "\"")).includes(communeCode);
                  });
                      ...
                      sectionsLayer = L.geoJSON(filteredSections, {
                        onEachFeature: function onEachFeature(feature, layer) {
                          layer.on('click', function () {
                            ...
                            var ventesDansCetteSection = ventes.filter(function (vente) {
                              return JSON.parse(vente.l_section.replace(/'/g, "\"")).includes(sectionCode);
                            });
